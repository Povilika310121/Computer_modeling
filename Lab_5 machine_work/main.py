...
def work(kol_tasks, total_time_machine=0):
    ...
    while time_before_next_task < 0:
        time_before_next_task += get_time_before_next_task()
        kol_det_in_que += 1
    return kol_brok, total_time_machine, total_time_machine / kol_tasks, kol_det_in_que, total_repair_time
...
print(f'Количество заданий: {kol_tasks}\n'
      ...
      f'Общее время починки: {int(res[4]//1)} часов {int(res[4]%1*60//1)} мин.')
print("________________________________________________________________________")
